...
You need to enter the pincode of the second wallet, and press `i` to generate invoice. Enter the invoice name (any string), amount and press enter, then quit the `tagionwallet` by pressing `ctrl + c` 
